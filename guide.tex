...
\usepackage{xspace,amsmath,hyperref,url,color,../../chicago,alltt,epsfig,subfigure,pifont}
...
\noindent{\bf Case 1:} Number of instances $\ll$ number of features
...
\noindent{\bf Case 2:} Both numbers of instances and features are
  large.
...
document classification. Let's consider a large
set {\tt 
...
\noindent{\bf Case 3:} Number of instances $\gg$ number of features.

As the number of features is small, one often
maps data to {\em higeher dimensional spaces}
