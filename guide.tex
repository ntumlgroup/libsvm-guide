...
\begin{alltt}\$./svm-scale -s range1 train.1 > train.1.scale
...
\item Scaled sets with default parameters
\begin{alltt}\$./svm-scale train.2 > train.2.scale
...
(Best $C$=2.0, $\gamma$=2.0 with five fold cross-validation rate=85.1662\%)
...
\item Scaled sets with default parameters
\begin{alltt}\$./svm-scale -s range3 train.3 > train.3.scale
