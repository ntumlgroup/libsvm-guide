...
\begin{alltt}$ time libsvm-2.84/svm-train -c 0.25 -t 0 -e 0.1 -m 800 -v 5 rcv1_train.binary
Cross Validation Accuracy = 96.6604%
608.042s
$ time liblinear-1.1/train -c 1 -e 0.01 rcv1_train.binary
Cross Validation Accuracy = 96.4579%
5.952s\end{alltt}
For five-fold cross validation,
\libsvm takes around 600 seconds, but
\liblinear uses only 6. Moreover,
